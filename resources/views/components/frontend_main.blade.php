        ...
        <div class="wrap-slick1">
            <div class="slick1">
                <div class="item-slick1"
                    style="background-image: url({{ asset('/frontend/images/slide-01.jpg') }});">
                ...
                <div class="item-slick1"
                    style="background-image: url({{ asset('/frontend/images/slide-03.jpg') }});">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
            ...
            <div class="p-t-40">
                ...
                <p class="stext-107 cl6 txt-center">
                    ...
                    <script>
                        ...
                        aria-hidden="true"></i> by <a href="#" target="_blank">WhiteCode.</a>
                    &amp;
                    distributed by <a href="#" target="_blank">SternTheme</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
